...
<%
	...
	ResMsgDTO resMsgDTO= transactMeAPI.refundTransaction(reqMsgDTO, propFilePath);
			//refundTransaction(reqMsgDTO);
    ...
    <table>
        <tr>
            ...
            <td><label for="one">: <%=resMsgDTO.getOrderId() %> </label></td>
             <td><label for="one"> Refund req ID  </label></td>
            <td><label for="one">: <%=resMsgDTO.getPgRefCancelReqId() %> </label></td>
			
        </tr>
       
        <tr>
        	 <td><label for="one"> Refund amount  </label></td>
            <td><label for="one">: <%=resMsgDTO.getRefundAmt()%> </label></td>
			<td><label for="one"> Refund request Status </label></td>
            <td><label for="one">: 
             ...
             <td><label for="one"> Refund Status Description </label></td>

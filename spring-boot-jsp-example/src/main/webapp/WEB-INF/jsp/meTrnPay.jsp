...
<body onload="postData();">
	...
	//	reqMsgDTO.setTrnAmt(Integer.parseInt(request.getParameter("trnAmt")));
		reqMsgDTO.setTrnAmt(request.getParameter("trnAmt"));

		//Merchant transaction currency
		//reqMsgDTO.setCurrency(request.getParameter("currency"));
		reqMsgDTO.setTrnCurrency(request.getParameter("currency"));
 ...
 */
		...
		reqMsgDTO.setResponseUrl(request.getParameter("resUrl"));
	...
	/* 	//reqMsgDTO.setCardNo(Integer.parseInt(request.getParameter("cardNo")));
		reqMsgDTO.setCardNumber(request.getParameter("cardNo"));
		// Card expiry date
		//reqMsgDTO.setExpDate(Integer.parseInt(request.getParameter("expDate")));
		reqMsgDTO.setExpiryDate(request.getParameter("expDate"));
		// Card cvv
		//reqMsgDTO.setCvv(Integer.parseInt(request.getParameter("cvv")));
		reqMsgDTO.setCvv(request.getParameter("cvv"));
		// Name on Card
 ...
 */
	...
	%> 
	<h1>storing is successfull
	</h1>
<form action="https://cgt.in.worldline.com/ipg/doMEPayRequest" method="post">
<center>

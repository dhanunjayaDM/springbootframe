		...
		<title>Merchant Site</title>
			...
			<script type="text/javascript">
				/* function getData()
				{
					...
					document.getElementById("hdnOrderID").value = Integer.parseInt(orderID);
					return true;
				} */
			/* 	onload="getData();" */
...
<body >
<div class="wrapper">
	<form action="meTrnCardReq"   method="post">
		 ...
		 <input type="text" name="id"/> 
			<table>
				...
				<tr>
					...
					<td><input type="text" value="http://localhost:8090/meTrnResKey" id="resUrl" name="resUrl"></td>
				</tr>
				<!-- <tr>
